...
export async function GET(request: NextRequest) {
  try {
    const auth = await requireAdminPermission(request, 'vendas'); if (!auth.ok) return auth.response
